...
- **Date**: today's date
- **Content**: short bulleted summary — what was collected/created, anything skipped and why, Email Whitelist Monitor result, Clean All results (counts moved), Investment Signal headline if any, notable issues.
