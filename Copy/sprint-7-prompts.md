# Sprint 7 – AI Agent Execution Prompts

Based on Sprint 6. Key change: **AI Agents Memory** and **Execution Log** now reference the copies under **Release folder sharp → Execution documents** instead of the old locations.
