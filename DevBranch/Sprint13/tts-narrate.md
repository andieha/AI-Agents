...
**Trigger:** Provide a Google Doc URL and type **Narrate to TTS**. No confirmation needed.

## What this does

Reads the aggregated report and rewrites it as flowing spoken narration optimised for
text-to-speech playback. Saves the result as a new plain-text file in Google Drive.
...
- Tickers and exchange codes → full speakable form on first use
  (e.g. "SSU on Xetra" rather than just "SSU", "SKHY on the Nasdaq" rather than "SKHY")
