...
system: |-
  ...
  Input: read the most recent "* – Verified" Google Doc from the output folder in your metadata (input_folder).

  1. Identify the file by searching the folder for the most recent document whose title ends in "– Verified".
...
metadata:
  ...
  input_folder: 1Ybc2UKM7jmwRxL5woyu1dp76xcjH-vl1
