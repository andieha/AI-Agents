...
description: Controls the Hybrid-4 research pipeline. Runs Preparation once to find all active topics for today, executes Steps 2–8 in parallel for every topic simultaneously, then runs Logger to save a full run log to Drive.
