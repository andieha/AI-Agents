...
- Email Summary fetches Gmail, classifies emails, drafts replies for anything requiring action, and logs to Google Drive (Email Memory folder).
...
- Investment Signals searches for AI/robotics news, assesses portfolio implications, and logs any actionable signals to Google Drive (AI Agents Memory folder).
