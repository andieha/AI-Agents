...
> **Unified-2**: this folder is a copy of `Execution/Unified/`, made 2026-07-20 and
> designated the new working version — the one to keep iterating on in Development.
> `Development/Unified/` (the original, pre-whitelist/context-doc-migration copy) and
> `Execution/Unified/` are both untouched by this copy and remain what any currently
> scheduled routine points at, until/unless this folder is promoted the same way.
