...
1. Search Google Drive (the `2 Work` folder, ID: `1FWKfAMO0oD4K8s4xzM3U0MD7pok3TTg3`) — check `Contacts`, `Flightright Case File`, and `Important` docs for context on this sender
...
**Email memory docs live in `2 Work`** (permanent, not inside Collection): Google Drive folder ID `1FWKfAMO0oD4K8s4xzM3U0MD7pok3TTg3`

Log to Google Drive (2 Work):
...
- Other case types → search for matching doc by name in 2 Work; create it if it does not exist
