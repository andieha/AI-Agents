...
system: |-
  ...
  2. Drop any source with a relevance score below 0.4.
     Also drop any source with a credibility score below 0.3 — unverified or
     promotional material damages the report regardless of relevance.

     On revision cycles (follow-up results from the Critic loop): drop any URL
     already scored in a previous round before scoring. Only new, unique
     sources proceed to the Writer.
