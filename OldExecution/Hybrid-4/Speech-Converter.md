...
description: Text-to-speech conversion agent for the Hybrid-4 pipeline. Reads the Research Report by the file ID passed from Save-infolder, strips all non-spoken content, rewrites for natural audio playback, enforces the character limit, and saves a plain-text TTS-ready file to the same folder.
